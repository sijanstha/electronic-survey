...
// Source: github.com/sijanstha/electronic-voting-system/internal/core/ports (interfaces: UserRepository,PollRepository,PollOrganizerRepository,ParticipantListRepository)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package=mockrepository -destination internal/adapters/repository/mock/mock.repository.go github.com/sijanstha/electronic-voting-system/internal/core/ports UserRepository,PollRepository,PollOrganizerRepository,ParticipantListRepository
//
...
// MockParticipantListRepository is a mock of ParticipantListRepository interface.
type MockParticipantListRepository struct {
	ctrl     *gomock.Controller
	recorder *MockParticipantListRepositoryMockRecorder
}

// MockParticipantListRepositoryMockRecorder is the mock recorder for MockParticipantListRepository.
type MockParticipantListRepositoryMockRecorder struct {
	mock *MockParticipantListRepository
}

// NewMockParticipantListRepository creates a new mock instance.
func NewMockParticipantListRepository(ctrl *gomock.Controller) *MockParticipantListRepository {
	mock := &MockParticipantListRepository{ctrl: ctrl}
	mock.recorder = &MockParticipantListRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockParticipantListRepository) EXPECT() *MockParticipantListRepositoryMockRecorder {
	return m.recorder
}
...
// FindAllParticipantList indicates an expected call of FindAllParticipantList.
func (mr *MockParticipantListRepositoryMockRecorder) FindAllParticipantList(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAllParticipantList", reflect.TypeOf((*MockParticipantListRepository)(nil).FindAllParticipantList), arg0)
}
...
// FindParticipantList indicates an expected call of FindParticipantList.
func (mr *MockParticipantListRepositoryMockRecorder) FindParticipantList(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindParticipantList", reflect.TypeOf((*MockParticipantListRepository)(nil).FindParticipantList), arg0)
}

// SaveParticipantList mocks base method.
func (m *MockParticipantListRepository) SaveParticipantList(arg0 *domain.ParticipantList) (*domain.ParticipantList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveParticipantList", arg0)
	ret0, _ := ret[0].(*domain.ParticipantList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SaveParticipantList indicates an expected call of SaveParticipantList.
